...
$self.className[registration_data]
$self.classDescription[Класс управления регистрационными данными]
$self.classModuleDescription[Регистрационные данные]
$self.classHistory[
	$.1_00[
		$.version(1.00)
		$.date[06.06.2018]
		$.changes[
			$.1[Создан класс управления регистрационными данными]
		]
	]
]
